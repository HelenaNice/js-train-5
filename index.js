...
// Перетворюємо кожен елемент в рядок
...
function printStrings(array) {
 let repeatedString = array.toString("").repeat(2);
...
function concatenateStrings(array, subString) {
  ...
  let string2 = string.includes(subString);

console.log("Is substring present:", string2);
